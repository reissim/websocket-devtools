...
(function () {
  ...
  // console.log("🔧 WebSocket Proxy injected script STARTING..."); Removed for clean up.
  ...
  if (window.websocketProxyInjected) {
    // console.log("⚠️ WebSocket Proxy already injected, skipping"); Removed for clean up.
    return;
  }

  // Immediately set flag
  window.websocketProxyInjected = true;
  // console.log("✅ WebSocket Proxy injection started"); Removed for clean up.
  ...
  // console.log("🏁 WebSocket Proxy injection complete"); Removed for clean up.
